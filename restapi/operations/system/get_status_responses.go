...
/*GetStatusOK API is operating normally
...
type GetStatusOK struct {
	...
	/*
	  In: Body
	*/
	Payload *models.SystemStatus `json:"body,omitempty"`
}
...
func (o *GetStatusOK) WithPayload(payload *models.SystemStatus) *GetStatusOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get status o k response
func (o *GetStatusOK) SetPayload(payload *models.SystemStatus) {
	o.Payload = payload
}
